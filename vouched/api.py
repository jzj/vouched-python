...
class Client:
    ...
    def update_secret_client_key(self, secret_client_key):
        data = query(
            ...
            update_secret_client_key_mutation,
            params=dict(
    ...
    def jobs(self, token=None, ids=None, id=None, type=None, status=None, to_date=None, from_date=None,
             sort_order=None, sort_by=None, page=None, page_size=None, with_photos=False, with_photo_urls=False):
    ...
    def submit(self, type='id-verification', include_alias_names=False, properties=None, user_photo=None,
               id_photo=None, user_photo_path=None, id_photo_path=None, callback_url=None, country='US',
               first_name=None, dob=None, last_name=None):
